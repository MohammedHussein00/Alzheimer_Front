...
@Component({
  selector: 'app-patient-detection',
  templateUrl: './patient-detection.component.html',
  styleUrls: ['./patient-detection.component.css']
})
export class PatientDetectionComponent {
  posterName: string[] = [];
